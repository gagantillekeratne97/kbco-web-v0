...
import { getCancelledInvoiceLists, getInvoiceLists } from "@/lib/apis";
import { Download, Search } from "lucide-react";
import CancelledInvoiceTable from "@/components/cancelled-invoice/CancelledTable";
...
export default function InvoicePage() {
  ...
  try {
    ...
    const data = await getCancelledInvoiceLists({
      query,
      fromDate,
      toDate,
      page: 1,
  ...
  return (
    <div className="flex min-h-screen bg-surface font-display">
        ...
        <div className="flex-1 flex flex-col min-w-0"> 
            <Topbar title="Cancelled Invoices"/>
