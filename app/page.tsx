  ...
  const handleLogin = async (
    ...
    try {
      ...
      if (remember) {
        ...
        // Session storage for normal login
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-10 sm:px-14">
          ...
          <div className="w-full max-w-sm mx-auto">
            ...
            <div className="flex md:hidden items-center gap-2.5 mb-8">
              ...
              <span className="font-display text-lg text-[#0B1F3A]">
                KBCO
              </span>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  disabled={loading}
                  className="w-full h-11 px-3.5 rounded-lg border bg-white text-sm text-[#14201C] placeholder:text-[#9CA3AF] outline-none transition-shadow focus:ring-2 focus:ring-[#E8722C]/40 focus:border-[#E8722C] border-[#E4E1D8] disabled:bg-gray-50 disabled:cursor-not-allowed"
                />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="w-full h-11 px-3.5 pr-11 rounded-lg border bg-white text-sm text-[#14201C] placeholder:text-[#9CA3AF] outline-none transition-shadow focus:ring-2 focus:ring-[#E8722C]/40 focus:border-[#E8722C] border-[#E4E1D8] disabled:bg-gray-50 disabled:cursor-not-allowed"
                  />
                  ...
                  >
                    ...
                    {showPassword ? (
                      ...
                      >
                        ...
                        <path
                          d="M3 3l18 18M10.6 10.6a2 2 0 002.8 2.8M9.9 5.1A9.7 9.7 0 0112 5c5 0 9 4 10 7-1 1.6-2.6 3.4-4.6 4.6M6.1 6.6C4.2 7.8 2.7 9.5 2 11c1 3 5 7 10 7a9.7 9.7 0 002.9-.4"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
              ...
              <div>
                ...
                <select
                  ...
                  disabled={loading}
                  className="w-full h-11 px-3.5 rounded-lg border bg-white text-sm text-[#14201C] outline-none transition-shadow focus:ring-2 focus:ring-[#E8722C]/40 focus:border-[#E8722C] border-[#E4E1D8] disabled:bg-gray-50 disabled:cursor-not-allowed"
                >
